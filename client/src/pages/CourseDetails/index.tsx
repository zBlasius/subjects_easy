...
export default function CourseDetails() {
    const [courseData, setCourse] = useState({ Name: "", Description: "", VideoList: [{ Description: "", Title: "", VideoLink: "" }] })
                ...
                <Col style={{ width: "100%", display: "flex", flexDirection: "column", alignItems: "center" }}>
                    {courseData.VideoList.map((item, index) => (
                        <Container style={{ padding: 8 }}>
                            <Row>
                                <Col xs={2} style={{ padding: "20px", width: "100%", textAlign: 'left'}}>

                                    <div style={{ height: "15rem", width: "22rem", marginBottom:25}}>
                                    ...
                                    <div >
                                        <span style={{fontWeight:600, fontSize:20}}> Aula {index + 1} </span>
                                        <p style={{ fontSize:18}}> {item.Description}</p>
                                    </div>

                                </Col>
                            </Row>
                            <div style={{width: "95%", borderBottom:"1px solid rgb(166 71 225 / 82%)"}}></div>
                        </Container>
                    ))}
                </Col>
            </Row>
